...
subtitle: "Supplementary materials: Full code base for simulations and figures"
author: 
  - "Melissa Chapman"
  - "Serge Wiltshire"
  - "Timothy Bowles"
...
ggarrange(
  sim_plot_ts(sims_short_tenure, 
              title = ggtitle("A. Short-tenure ES state timeseries"), 
...
ggarrange(
  ...
  ggarrange(
    plt_sim_b_sweep(myopic_d_sims, 
                    title = ggtitle("B. Unrealistically short-term
                                    \n     decision strategy"), 
  ...
  ggarrange(
    plt_sim_b_sweep(fast_r_sims, 
                    title = ggtitle("C. Unrealistically fast
