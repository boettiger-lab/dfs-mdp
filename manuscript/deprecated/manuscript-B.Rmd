...
```{r fig_bifurcation, fig.cap="Simulations of the ecosystem state of 500 farming plots over time. Plots are initialized with a truncated normal distributed ecosystem state (mean state 0.5, standard deviation 0.2, truncated at 0,1).  Plots are then managed according to the decision rule as discussed in the main text."}
sim_plot(sims)
```
