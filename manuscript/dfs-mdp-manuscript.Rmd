...
{>>Include figure \ref{fig:mth_tipping}?<<}

\begin{figure}
{\centering \includegraphics{external-figs/methods1a.png}}
\caption{Millie's conceptual MDP tipping point figure...}\label{fig:mth_tipping}
\end{figure}
