...
ggarrange(
  sim_plot_ts(sims_baseline, title = ggtitle("A. ES state timeseries"), rmarmod = -5), 
...
ggarrange(
  sim_plot_ts(sims_short_tenure, title = ggtitle("A. Short-tenure ES state timeseries"), 
