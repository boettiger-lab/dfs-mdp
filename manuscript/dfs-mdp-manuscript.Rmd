...
predictions <- data.frame(`Predictions`= 
                     c("P1: Bistability in ecosystem states (ecosystem services) can emerge without complex structural assumptions about nonmonotonic cost structures or ecological dynamics (Fig 2)",
                       "P2: As ecological processes become infinitely “fast” (in their response to management actions) bistability under simple assumptions no longer emerges.",
                       "P3: Decision making over short time horizons decreases investment in ecosystem service promoting activities (Fig 4) and  removes bistability as decision horizons become short (Fig 5B)",
                       "P4: Longer, more sustained incentive programs tend to be more effective at encouraging adoption of processes with benefits that accrue slowly",
                       "P5: Short term incentive programs have lower capacity to sustain impact on ecosystem services"),
                   `Evidence`=c("Syndromes of production, or bistable trajectories in adoption of agricultural practices, have been both empirically and theoretically documented (Vandermeer 2012, 1997)", 
                                "No ecological systems are truly infinitely fast. However, given a favorable cost benefit ratio, fast practices will largely be adopted rather than displaying bimodal distributions, for example…",
                                "U.S. corn farmers who rent land are less likely than landowners to implement grassed waterways, strip cropping, contour farming, and conservation tillage (CITE)",
                                "policy example",
                                "policy example"))

kable(predictions, "latex") %>%
