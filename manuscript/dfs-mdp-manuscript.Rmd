...
sim_b_sweep <- function(scenarios, inf_fin, t_horiz = 2) {
  ...
  if(inf_fin == "infinite") {
    ...
    soln <- MDPtoolbox::mdp_finite_horizon(model$P, model$U, discount, N = t_horiz)
...
fast_r_scenarios <-
  tidyr::crossing(benefit = seq(1, 2, length.out = 50),
                  cost = 1,
                  sigma = 0.1,
                  r = 0.6,
                  discount = 0.97,
...
myopic_d_scenarios <- 
  tidyr::crossing(benefit = seq(5, 15, length.out = 50),
                  cost = 1,
                  sigma = 0.1,
                  r = 0.1,
                  discount = 0.97,
