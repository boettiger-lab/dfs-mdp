...
abstract: There is a growing recognition that understanding and predicting tipping points both in social systems and ecological phenomena is critically important. Despite widespread interest in integrated human-natural systems, it is often assumed that the underlying forces that lead to nonlinear behavior rest either in social process or natural phenomena alone. Our work shows how alternative stable states can arise in a stylized coupled human and natural systems model representing adoption of sustainable agricultural practices. Our Markov Decision Process model captures temporal feedbacks between a farmer\'s investment choice, based on their perceived utility over a given time horizon, and probabilistic changes in the ecological services derived from the environment. Because benefits of ecosystem services take time to acrue, farmers in environments with degraded land are unlikely to invest in agriecology, while farmers who benefit from ecosystem services are more likely to bolster those services further. This path dependency leads to a bifurcation into either a more-simplfied or a more-diversified farming approach, which has also been found empirically. We show that this tipping point need not be an inherent feature of either ecological or psychological dynamics in isolation, but can emerge as a very general pattern by dynamically coupling a simple ecosystem model with a rational decision process over time.  We suggest that better understanding such tipping point dynamics can have important implications for policy design across a range of domains, from land tenure to agricultural subsidies.
...
Both ecosystems and social systems have been observed to abruptly change states as the result of crossing a threshold. While theories of ecological multistability describe this phenomenon in ecosystems \cite{scheffer2003catastrophic} and many studies have explored how management impacts stability landscapes in ecological systems \cite{Horan7333} underlying tipping dynamics are assumed to be present in the ecological system. Similarly, examples from the social systems suggest similar tipping points but as the result of tipping dynamics present in the social systems; from the collapse of societies \cite{downey2016european} to social networks dynamics \cite{kuehn2014critical}.  Despite widespread interest in and importance of integrated socio-ecological systems, it is generally assumed that the underlying alternative stable states must be ascribed either to social process or natural phenomenon alone. 

While the coupled human and natural systems literature has advanced our understanding of state shifts, empirical observations of alternate stable states may not always be attributed to underlying dynamics of a single system but rather the emergent properties of their coupled dynamics. (add more here)
