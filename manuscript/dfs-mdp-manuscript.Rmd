...
In the context of diversified farming systems, diversification practices include hedgerows, crop rotation, intercrops, the use of compost, growing multiple crop types, reduced tillage, and cover crops. This type of diversification is distinct from the concept of operational diversification (i.e., simply increasing the range of agricultural goods produced on a given farm). 
