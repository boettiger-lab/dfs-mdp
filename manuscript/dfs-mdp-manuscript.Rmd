...
ggarrange(
  sim_plot_ts(sims_short_tenure, title = ggtitle("A. Short-tenure \n state timeseries"), 
...
ggarrange(
  ...
  ggarrange(
    plt_sim_b_sweep(myopic_d_sims, title = ggtitle("B. short-term\n     decision strategy"), 
  ...
  ggarrange(
    plt_sim_b_sweep(fast_r_sims, title = ggtitle("C. fast\n     ecological dynamics"), 
