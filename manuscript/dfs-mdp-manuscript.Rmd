...
abstract: The emergence and impact of tipping points have been of immense interest both in studies of social systems and natural phenomena. Despite widespread recognition of the importance of integrated human-natural systems, it is often assumed that the underlying forces that lead to nonlinear behavior rest either in social process or natural phenomena alone. Our work shows how alternative stable states can arise in a stylized coupled human and natural systems model representing adoption of sustainable agricultural practices. Temporal feedbacks between a farmer\'s investment choice, based on their perceived utility over a given time horizon, and probabilistic changes in the ecological services derived from the environment can result in alternate stable states. Because benefits of ecosystem services take time to accrue, farmers in environments with degraded land are unlikely to invest in agroecology, while farmers who benefit from ecosystem services are more likely to bolster those services further. This path dependency leads to a bifurcation into either a more-simplified or a more-diversified farming approach, which has also been found empirically. We show that this tipping point need not be an inherent feature of either ecological or decision dynamics but can emerge as a very general pattern by dynamically coupling a simple ecosystem model with a rational decision process over time.  We suggest that better understanding such tipping point dynamics have important implications for policy design across a range of domains, from land tenure to agricultural subsidies.
...
Both ecosystems and social systems have been observed to abruptly change states as the result of crossing a threshold. While theories of ecological multistability have long described this phenomenon in ecosystems \cite{scheffer2003catastrophic} and explored how management impacts stability landscapes in ecological systems \cite{Horan7333} underlying tipping dynamics are assumed to be present in the ecological system. Similarly, examples from the social systems suggest similar tipping points but as the result of tipping dynamics present in the social systems; from the collapse of societies \cite{downey2016european} to social networks dynamics \cite{kuehn2014critical}.  Despite widespread interest in the causes and location of tipping points in integrated socio-ecological systems, it is generally assumed that the underlying alternative stable states must be ascribed either to social process or natural phenomenon alone.

However, empirically exploring tightly coupled dynamic systems presents numerous challenges \cite{kline2017integrating}.  Human decisions impact ecological processes and the resultant changes create feedbacks that alter the scope and efficacy of future decisions \cite{ostrom2009general, walker2004resilience, liu2007complexity}.  Decisions can enhance or degrade ecological services that affect the long-term productive capacity of the land base and impact future financial returns \cite{zhang2007ecosystem}.  However, the temporal dynamics of ecological processes do not always align with the temporal scale of human decision-making.  For example, many ecosystem services the the result of sequential investment in practices and take years to accrue, meaning adoption of these practices requires decisionmakers to be foreward looking, adaptive, and cognizant of environmental and economic uncertainty.  
