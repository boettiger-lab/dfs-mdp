...
abstract: This document gives the full codebase used to define and parameterize the MDP model, run all simulations, and produce the final plots that appear in the accompanying manuscript.
author:
...
We use the following packages for our the MDP simulation: 
...
We first define the action space, $A$, and state space, $S$ 
...
And define the set parameters for study
