...
```{r res_bimodal, fig.width = 6.5, fig.asp = .5, dpi=500}
ggarrange(
  soln_plot(base_soln_df %>% filter(state <= state99th), tpt = tpt),
...
```{r res_tenure,  fig.width = 6.5, fig.asp = .5,dpi=500}
ggarrange(
...
```{r res_incentive, fig.width = 6.5, fig.asp = .50, dpi=500}
ggarrange(
...
```{r res_b_sweep1,  fig.width = 6.5, fig.asp = .55, dpi=500}
ggarrange(
  ggarrange(
